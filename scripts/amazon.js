...
loadProductFetch(renderProductaGrid)
...
function renderProductaGrid() {
  ...
  products.forEach(product => {
      ...
      <div class="product-container">
            ...
            <div class="added-to-cart js-added-mark" data-product-id="${product.id}">
  ...
  .forEach(button => {
      button.addEventListener("click", () => {
        ...
        const addedMark = document.querySelector(`.js-added-mark[data-product-id="${productId}"]`);
